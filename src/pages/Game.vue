    ...
    <div class="flex-1 flex justify-between items-center bg-contain bg-repeat-x bg-center bg-[#18181b] lg:h-1/2 max-lg:-my-16 max-lg:bg-cover"
        ...
        <div class="flex flex-col justify-center items-center h-1/3 mr-12 max-lg:h-1/5">
            <div class="flex stroke-black-text text-white text-2xl">
                ...
                <p class="text-red-500" v-show="show.playerAttack">&nbsp;{{ `-${monster.damage}` }}</p>
            </div>
...
.character-turn {
    filter: 
    drop-shadow(0.25rem 0 0 rgba(255, 255, 255, 0.6)) 
    drop-shadow(0 0.25rem 0 rgba(255, 255, 255, 0.6)) 
    drop-shadow(-0.25rem 0 0 rgba(255, 255, 255, 0.6)) 
    drop-shadow(0 -0.25rem 0 rgba(255, 255, 255, 0.6));
}
.stroke-red-text {
